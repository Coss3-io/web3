<template>
  <div class="p-2 w-full">
    <div
      class="overflow-hidden grid grid-cols-12 grid-rows-[min-content_1fr_auto_1fr_1fr] lg:grid-rows-[min-content_1fr_1fr] bg-base-300 rounded-lg p-5 gap-3 w-full lg:h-[calc(100vh-110px)]"
    >
