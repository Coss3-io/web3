  ...
  <div class="p-2 w-full">
    ...
    >
      <div class="col-span-full m-2 flex justify-start">
        <div class="tooltip" data-tip="click for help">
          <button class="flex gap-4 btn btn-ghost text-4xl font-bold">
            <lendingLogo class="w-12 h-12"></lendingLogo>
            Lending
          </button>
        </div>
      </div>
      ...
      >
        ...
        <div
          class="flex flex-col items-center justify-center w-full h-full gap-2 font-bold text-lg"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
      ...
      >
        ...
        >
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            class="w-9 h-9 animate-[spin_3s_linear_infinite;]"
          >
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
      ...
      >
        ...
        >
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            class="w-9 h-9 animate-[spin_2s_linear_infinite;]"
          >
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
